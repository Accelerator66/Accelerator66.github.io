...
### 基于知识的视觉场景组成式表示学习 —— 国家自然科学基金(面上项目)

*学生负责人*，*2022.1 — 现在*

负责研究基于知识的组成式场景表示学习框架；负责研究组成式的场景变化规则学习方法，提出了基于隐随机函数先验、受人类认知过程启发的组成式场景变化规则学习框架，在多个场景与指标中取得显著的性能提升；负责项目材料 的撰写、汇报等工作；负责项目整体推进、撰写项目年度进展报告等。

### 基于隐变量推断的视觉概念学习 —— 上海市“科技创新行动计划”项目

*主要参与*，*2020.10 – 2023.9*

负责研究基于深度隐变量模型的场景表示解耦方法，提出了基于物体空间关系的隐变量解耦方法，显著提高了无监督场景下视觉概念学习的准确率；负责研究场景空间布局的建模方法，提出了结合解耦表示与高斯过程先验的场景布局概率生成模型。参与项目材料撰写、汇报等工作；负责项目的整体验收，包括科技报告、自评价报告等材料的撰写。

### 医学影像中关键特征点的半监督学习方法 —— 上海市科技重大专项
